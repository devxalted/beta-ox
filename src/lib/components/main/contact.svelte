<div id="contact" class="basis-full">
    <div class="flex flex-wrap justify-center">
        <h2 class="font-bold text-gray-600 text-xl 2xl:text-3xl my-6 basis-full text-center">
            Let's Get Started!
        </h2>
        <p class="text-gray-600 text-center px-3 md:px-0">
            You can contact me via email or social media by clicking any of the links below:
        </p>
